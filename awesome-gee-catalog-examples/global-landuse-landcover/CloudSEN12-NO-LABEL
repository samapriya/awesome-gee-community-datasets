...
var img = ee.Image(cs12_nolabel.toList(1, ip_id).get(0)) // Label
img = img.updateMask(img.neq(0)) // nolabel subset does not have ground truth values
...
Map.addLayer(img, {},"cloudSEN12 human photointerpretation")